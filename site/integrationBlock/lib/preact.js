...
function b(n, l, u) {
  "-" === l[0]
    ...
    : (n[l] =
        null == u ? "" : "number" != typeof u || a.test(l) ? u : u + "px");
}
  ...
  n: if ("style" === l) {
    if ("string" == typeof u) n.style.cssText = u;
      ...
      if (("string" == typeof i && (n.style.cssText = i = ""), i))
        for (l in i) (u && l in u) || b(n.style, l, "");
    ...
    (r = l !== (l = l.replace(/Capture$/, ""))),
      ...
      (n.l[l + r] = u),
      u
        ? i || n.addEventListener(l, r ? w : m, r)
        : n.removeEventListener(l, r ? w : m, r);
...
function I(n, l, u) {
  for (var i, t = n.__k, r = 0; t && r < t.length; r++)
    (i = t[r]) &&
      ((i.__ = n),
      (l = "function" == typeof i.type ? I(i, l, u) : z(u, i, i, t, i.__e, l)));
  return l;
}
function j(n, l) {
  return (
  ...
  try {
    n: if ("function" == typeof $) {
      ...
      (a.state = a.__s),
        ...
        H(n, Array.isArray(T) ? T : [T], u, i, t, r, o, f, e, c),
        (a.base = u.__e),
        (u.__h = null),
...
function O(l, u, i, t, r, o, f, e) {
  ...
  if (null === d) y === p || (e && l.data === p) || (l.data = p);
    ...
    if (
      ...
      (a = (y = i.props || c).dangerouslySetInnerHTML),
    ...
    if ((k(l, p, y, r, e), h)) u.__k = [];
      ...
      for (_ = o.length; _--; ) null != o[_] && v(o[_]);
    e ||
      ("value" in p &&
        void 0 !== (_ = p.value) &&
        (_ !== l.value ||
          ("progress" === d && !_) ||
          ("option" === d && _ !== y.value)) &&
        g(l, "value", _, y.value, !1),
      "checked" in p &&
        void 0 !== (_ = p.checked) &&
        _ !== l.checked &&
        g(l, "checked", _, y.checked, !1));
  }
  return l;
}
function S(n, u, i) {
...
(n = s.slice),
  ...
  (x.prototype.setState = function (n, l) {
    ...
    (u =
      ...
      n && h(u, n),
      null != n && this.__v && (l && this._sb.push(l), T(this));
  }),
